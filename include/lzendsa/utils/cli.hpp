...
CommandLineArguments parse_args(int argc, char** argv, std::set<std::string> const &allowed_value_options, std::set<std::string> const &allowed_literal_options, int fixed_parameter_count) {
